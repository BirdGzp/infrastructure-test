package com.moon.infrastructure.fallback.aspect;
...
public class DefaultFallbackAop {
    ...
    @Around(value = "execution(public * com..feign..fallback..*.*(..))&& @annotation(com.moon.infrastructure.fallback.DefaultFallback)")
