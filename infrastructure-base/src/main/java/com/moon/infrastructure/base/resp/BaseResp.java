...
public class BaseResp implements RespCode
{
	...
	public static final BaseResp REDIS_TRY_LOCK_TIME_OUT = new BaseResp("990012", "获取 redis 分布式锁超时");
	public static final BaseResp IO_RUNTIME_EXCEPTION = new BaseResp("990013", " IO异常");
